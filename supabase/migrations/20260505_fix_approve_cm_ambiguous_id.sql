-- Fix: column reference "id" is ambiguous in approve_cm, approve_parallel_branch, dispatch_parallel.
-- RETURNS TABLE declares an OUT param named "id", conflicting with unqualified
-- column references inside the function body. Qualify every table "id" usage.
